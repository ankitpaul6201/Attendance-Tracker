...
// Stable empty array reference to avoid creating new array on every render
const EMPTY_ATTENDANCE: NonNullable<AttendanceCalendarProps['attendanceData']> = [];

export function AttendanceCalendar({ className, attendanceData = EMPTY_ATTENDANCE }: AttendanceCalendarProps) {
        ...
        <GlassCard className={cn("p-6 min-h-[400px]", className)}>
                                ...
                                <div
                                    ...
                                    className={cn(
                                        ...
                                        isSelected
                                            ...
                                            : "hover:bg-[var(--foreground)]/5 text-gray-400",
            ...
            <div className="mt-6 pt-4 border-t border-[var(--color-border)]">
                <div className="flex items-center justify-between text-xs text-gray-500 font-medium">
                    <span>Selected: <span className="text-[var(--foreground)] ml-2">{format(selectedDate, "MMM d, yyyy")}</span></span>
