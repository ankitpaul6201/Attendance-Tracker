...
export function BottomNavBar() {
    ...
    return (
        <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 px-4 pb-8 pt-2 pointer-events-none">
            <div className="bg-[#0A0A0A]/90 backdrop-blur-xl border border-white/10 rounded-full shadow-2xl pointer-events-auto max-w-[90%] mx-auto">
                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            <div
                                ...
                                className={cn(
                                    "relative flex flex-col items-center justify-center w-12 h-12 rounded-full transition-colors duration-300 z-10 no-touch-callout cursor-pointer active:scale-95",
